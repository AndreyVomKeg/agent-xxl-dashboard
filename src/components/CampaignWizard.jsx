    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 15, fontWeight: 600 }}>Новая кампания</div>
          ...
          <div style={{ padding: "12px 16px", borderTop: "1px solid " + C.bd }}>
            <div style={{ display: "flex", gap: 8 }}>
              <input autoFocus placeholder="Опишите цель кампании..."
                ...
                style={{ flex: 1, border: "1px solid " + C.bs, borderRadius: 10, padding: "10px 14px", fontSize: 13, outline: "none", fontFamily: "inherit" }}
              />
              <button onClick={e => {
                ...
                background: "#c7623e", color: "#FFF", fontSize: 13,
        ...
        {wiz.step === 2 && (
          <div style={{ padding: "16px 20px", borderTop: "1px solid " + C.bd }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 16 }}>
              <div>
                <div style={{ fontSize: 11, fontWeight: 500, color: C.tt, marginBottom: 4 }}>НАЗВАНИЕ</div>
                <input value={wiz.nm} onChange={e => setWiz(p => ({ ...p, nm: e.target.value }))} style={inputStyle} />
              </div>
              <div>
                <div style={{ fontSize: 11, fontWeight: 500, color: C.tt, marginBottom: 4 }}>ТИП</div>
              ...
              <div>
                <div style={{ fontSize: 11, fontWeight: 500, color: C.tt, marginBottom: 4 }}>ГЕО</div>
                <input value={wiz.geo} onChange={e => setWiz(p => ({ ...p, geo: e.target.value }))} style={inputStyle} />
              </div>
              <div>
                <div style={{ fontSize: 11, fontWeight: 500, color: C.tt, marginBottom: 4 }}>БЮДЖЕТ ₽/ДЕНЬ</div>
                <input type="number" value={wiz.b} onChange={e => setWiz(p => ({ ...p, b: +e.target.value }))} style={inputStyle} />
              </div>
              <div>
                <div style={{ fontSize: 11, fontWeight: 500, color: C.tt, marginBottom: 4 }}>МАКС CPA ₽</div>
                <input type="number" value={wiz.mc} onChange={e => setWiz(p => ({ ...p, mc: +e.target.value }))} style={inputStyle} />
              </div>
              <div>
                <div style={{ fontSize: 11, fontWeight: 500, color: C.tt, marginBottom: 4 }}>АВТОНОМИЯ АГЕНТОВ</div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <button onClick={onClose} style={{
                ...
                background: C.sf, fontSize: 13, cursor: "pointer", fontFamily: "inherit",
              }}>Отменить</button>
